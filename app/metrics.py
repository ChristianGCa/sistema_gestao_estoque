...
def get_sales_metrics():
    ...
    )['total_products_sold'] or 0  # Se isso retornar null, usa 0 pois a base de dados pode estar vazia
...
def get_daily_sales_data():
    ...
    # Criar uma lista de dias
    dates = [str(today - timezone.timedelta(days=i)) for i in range(6, -1, -1)]
    values = list()

    # Para cada dia, vou usar o ORM para ver os valores de vendas
    for date in dates:
